...
public class Stocks extends javax.swing.JFrame {
    ...
    public void getStocks(){
       Connection conn = new GetConnection().getConnection();
        try{
            PreparedStatement ps =  conn.prepareStatement("SELECT name AS 'Medicines Name', quantity AS 'Quantity Available'FROM medicines ORDER BY name");
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Stock Available", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Sitka Display", 0, 18))); // NOI18N
